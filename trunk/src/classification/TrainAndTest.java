...
public class TrainAndTest
{
	...
	// Without third profile feature -> with third profile feature -> with better state transition normalizer
	public static final int[] cellStateOrder = {0, 1, 2};  // 88.5 -> 89.1 -> 90.9
	//public static final int[] cellStateOrder = {2, 0, 1};  // 88.5 -> 88.3 -> 89.1
	//public static final int[] cellStateOrder = {0, 2, 1};  // 89.6 -> 89.3 -> 89.1
	//public static final int[] cellStateOrder = {1, 0, 2};  // 89.9 -> 89.3 -> 90.9
	//public static final int[] cellStateOrder = {2, 1, 0};  // 90.4 -> 90.9 -> 91.2
	//public static final int[] cellStateOrder = {1, 2, 0};  // 91.2 -> 91.5 -> 90.7
